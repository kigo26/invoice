              ...
              {isAddingSupplier ? (
                ...
                >
                  <div className="bg-[#141414] border border-[#1F1F1F] rounded-2xl p-8 space-y-6">
                    <h3 className="text-lg font-bold text-white mb-6">Onboard New Supplier</h3>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-6">
                      <div className="w-20 h-20 rounded-3xl bg-amber-600/10 border border-amber-500/20 flex items-center justify-center text-amber-400">
                        <Truck size={40} />
                      </div>
                      <div>
                        <h2 className="text-3xl font-bold text-white tracking-tight">{selectedSupplier.name}</h2>
